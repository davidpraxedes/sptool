...
(function () {
    ...
    paymentTabs.forEach(tab => {
        tab.addEventListener('click', function () {
            ...
            // 🎨 Mudar cor dos ícones dos labels conforme método selecionado
            const labelIcons = document.querySelectorAll('.form-label svg');
            if (method === 'mbway') {
                // MBWay = Vermelho
                labelIcons.forEach(icon => {
                    icon.style.stroke = '#E53E3E'; // Vermelho MBWay
                });
            } else if (method === 'multibanco') {
                // Multibanco = Azul
                labelIcons.forEach(icon => {
                    icon.style.stroke = '#3B82F6'; // Azul Multibanco
                });
            }
