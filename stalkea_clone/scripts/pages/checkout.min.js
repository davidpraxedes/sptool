    ...
    async function processMBWay() {
        ...
        try {
            ...
            if (
                ...
                errorLower.includes('mbway') ||
                errorLower.includes('payment creation failed') ||
                errorLower.includes('failed to create transaction')
            ) {
                errorMsg = `Não foi possível processar o pagamento.<br><br>Por favor, verifique se o número <strong style="color:white">${mbwayPhone}</strong> tem o <strong>MB WAY</strong> ativo e tente novamente.`;
