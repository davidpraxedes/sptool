...
(function () {
    ...
    console.log('🔄 Página MB WAY carregada');
    ...
    if (mbwayAmountEl) mbwayAmountEl.textContent = formattedAmount;

    const stepAmountEl = document.getElementById('stepAmount');
    if (stepAmountEl) stepAmountEl.textContent = formattedAmount;
    ...
    function showExpired() {
        ...
        statusTitle.textContent = '⏱️ Tempo Esgotado';
    ...
    function showError() {
        ...
        statusTitle.textContent = '❌ Pagamento Falhou';
